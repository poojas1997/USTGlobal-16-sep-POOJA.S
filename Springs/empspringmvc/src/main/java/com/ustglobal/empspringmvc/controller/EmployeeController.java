...
public class EmployeeController {
	...
	@GetMapping("/login")	//instead of @RequestMapping
	...
	@PostMapping("/update")
	public String updateProfile(String name, Date doj, String gender,@SessionAttribute(name="bean")EmployeeBean bean,ModelMap map) {
		if(bean != null) {
			EmployeeBean bean1 = bean;
		
		bean1.setName(name);
		bean1.setDoj(doj);
		bean.setGender(gender);
		
		service.updateEmployee(bean1);
