...
public class HelloController {
	...
	@InitBinder
	public void init(WebDataBinder binder) {								//to get custom date editor
	...
	//	public String welcome(HttpServletRequest request) {  ModelMap works like this
	//		request.setAttribute("msg", "Hello World");
	//		return "index";
	//	}

	@RequestMapping(path= "/hi/{name}/{id}")									//	Path Parameter
	...
	public String formPage() {				//Form Data
		return "form";
	}
	...
	public String createCookie(ModelMap map, HttpServletResponse response) {			//Cookie
